        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3>Subir CSV para {{ $user->name }} {{ $user->middle_name }} {{ $user->last_name }}</h3>
                </div>
                <form action="{{ route('store_csv_by_operator',$user->id) }}" method="post" enctype="multipart/form-data" class="form">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
